...
class CountDown extends Component {
  ...
  componentDidMount() {
    this.deadline = new Date("Sep 30, 2022 21:00:00").getTime();
  ...
  render() {
    ...
    return (
      <div id="countdown">
        <div className="comingsoon-col25">
          <div className="box">
            <p id="day">{days}</p>
        ...
        <div className="comingsoon-col25">
          <div className="box">
            <p id="hour">{hours}</p>
            <span className="text">Godziny</span>
          </div>
        </div>
        <div className="comingsoon-col25">
          <div className="box">
            <p id="minute">{minutes}</p>
            <span className="text">Minuty</span>
          </div>
        </div>
        <div className="comingsoon-col25">
          <div className="box">
            <p id="second">{seconds}</p>
            <span className="text">Sekundy</span>
          </div>
        </div>
      </div>
    );
